...
namespace BehaviorDesigner.Runtime.Tasks.Movement
{
    ...
    public class Search : Action
    {
        ...
        public override TaskStatus OnUpdate()
        {
            ...
            objectFound.Value = MovementUtility.WithinSight(transform, fieldOfViewAngle.Value, viewDistance.Value, objectLayerMask);
            ...
            if (senseAudio.Value) {
                objectFound.Value = MovementUtility.WithinHearingRange(transform, linearAudibilityThreshold.Value, hearingRadius.Value, objectLayerMask);
