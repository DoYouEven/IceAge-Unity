...
namespace RootMotion.FinalIK.Demos {
	...
	public class FPSAiming : MonoBehaviour {
		...
		void LateUpdate() {
			...
			ik.solver.leftHandEffector.positionWeight = aimWeight > 0 && sightWeight > 0? 1f: 0f;
		...
		private void LookDownTheSight() {
			...
			ik.solver.leftHandEffector.bone.rotation = gunTarget.rotation * leftHandRelativeRotation;
			ik.solver.rightHandEffector.bone.rotation = gunTarget.rotation * rightHandRelativeRotation;
